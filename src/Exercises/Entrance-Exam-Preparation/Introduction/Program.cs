...
namespace Introduction
{
    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            details.Add("I am a recent graduate from the University of Veliko Tarnovo." +
                "There I have studied Software Engineering as a Bachelor degree");
            details.Add("I am currently working as a Software Developer with C# and .NET");
            details.Add("My work involves developing desktop and web applications");
            details.Add("I am working forward to work with you in the Practical Software Development course");
